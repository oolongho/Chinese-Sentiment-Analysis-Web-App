...
const PerformancePage: React.FC = () => {
  ...
  const fetchData = useCallback(async () => {
    try {
      const [statsRes, historyRes, dictStatsRes] = await Promise.all([
        fetch(`${API_ENDPOINTS.performance}/stats`),
        fetch(`${API_ENDPOINTS.performance}/cpu-gpu-history?limit=50`),
        fetch(`${API_ENDPOINTS.training}/dictionary/stats`)
      ]);
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-5 border border-blue-100 hover:shadow-lg transition-all duration-300">
                ...
                <div className="text-3xl font-bold text-gray-900">{dictStats.degree_count}</div>
              </div>
              <div className="bg-gradient-to-br from-yellow-50 to-amber-50 rounded-2xl p-5 border border-yellow-100 hover:shadow-lg transition-all duration-300">
                ...
                <div className="text-3xl font-bold text-gray-900">{dictStats.negation_count}</div>
              </div>
            </div>
          </div>
